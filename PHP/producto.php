...
class Producto {
 ...
 // sql para borrar un producto
    function getDeleteSQL() {
    $sql="DELETE FROM productos where codigo=$this->codigo";
	return $sql;
}

 // sql para update un producto
    function getUpdateSQL() {
    $sql="UPDATE productos SET descripcion='$this->descripcion',rebaja=$this->porcentajeRebaja,estarebajas=$this->estaRebajado,precio=$this->precio WHERE codigo=$this->codigo";
	return $sql;
}
