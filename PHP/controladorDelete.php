<html>
  <head>
    <title>Proceso de borrado del producto</title>
  </head>
  <body>
...
$productoBorrado = new Producto($codigo,$descripcion,$rebaja,$estarebajado,$precio);


//Vamos a por la
$SQLDelete = $productoBorrado->getDeleteSQL();
